...
class AirHockeyRenderer1(private val context: Context,isPerspective:Boolean) : BaseRenderer(context,isPerspective) {
    ...
    override fun onSurfaceCreated(gl: GL10?, config: EGLConfig?) {
        ...
        line0 = Line(0, Point(-0.18f, 0.05f, 0f), 0.1f, 0.2f,HierarchyClass.LOW_LAYER)
        line1 = Line(1, Point(-0.18f, 0.2f, 0f), 0.1f, 0.2f,HierarchyClass.LOW_LAYER)
        line2 = Line(2, Point(-0.18f, 0.35f, 0f), 0.1f, 0.2f,HierarchyClass.LOW_LAYER)
        line3 = Line(3, Point(-0.18f, 0.5f, 0f), 0.1f, 0.2f,HierarchyClass.LOW_LAYER)
        line4 = Line(4, Point(-0.18f, 0.65f, 0f), 0.1f, 0.2f,HierarchyClass.LOW_LAYER)
        line5 = Line(5, Point(-0.18f, 0.8f, 0f), 0.1f, 0.2f,HierarchyClass.LOW_LAYER)

        line6 = Line(6, Point(0.18f, 0.05f, 0f), 0.1f, 0.2f,HierarchyClass.LOW_LAYER)
        line7 = Line(7, Point(0.18f, 0.2f, 0f), 0.1f, 0.2f,HierarchyClass.LOW_LAYER)
        line8 = Line(8, Point(0.18f, 0.35f, 0f), 0.1f, 0.2f,HierarchyClass.LOW_LAYER)
        line9 = Line(9, Point(0.18f, 0.5f, 0f), 0.1f, 0.2f,HierarchyClass.LOW_LAYER)
        line10 = Line(10, Point(0.18f, 0.65f, 0f), 0.1f, 0.2f,HierarchyClass.LOW_LAYER)
        line11 = Line(11, Point(0.18f, 0.8f, 0f), 0.1f, 0.2f,HierarchyClass.LOW_LAYER)

        line12 = Line(12, Point(0.18f, 0.95f, 0f), 0.1f, 0.2f,HierarchyClass.LOW_LAYER)
        line13 = Line(13, Point(0.18f, 1.1f, 0f), 0.1f, 0.2f,HierarchyClass.LOW_LAYER)
        line14 = Line(14, Point(0.18f, 1.25f, 0f), 0.1f, 0.2f,HierarchyClass.LOW_LAYER)
        line15 = Line(15, Point(0.18f, 1.4f, 0f), 0.1f, 0.2f,HierarchyClass.LOW_LAYER)
        line16 = Line(16, Point(0.18f, 1.55f, 0f), 0.1f, 0.2f,HierarchyClass.LOW_LAYER)
        line17 = Line(17, Point(0.18f, 1.7f, 0f), 0.1f, 0.2f,HierarchyClass.LOW_LAYER)

        line18 = Line(18, Point(-0.18f, 0.05f, 0f), 0.1f, 0.2f,HierarchyClass.LOW_LAYER)
        line19 = Line(19, Point(-0.18f, 0.2f, 0f), 0.1f, 0.2f,HierarchyClass.LOW_LAYER)
        line20 = Line(20, Point(-0.18f, 0.35f, 0f), 0.1f, 0.2f,HierarchyClass.LOW_LAYER)
        line21 = Line(21, Point(-0.18f, 0.5f, 0f), 0.1f, 0.2f,HierarchyClass.LOW_LAYER)
        line22 = Line(22, Point(-0.18f, 0.65f, 0f), 0.1f, 0.2f,HierarchyClass.LOW_LAYER)
        line23 = Line(23, Point(-0.18f, 0.8f, 0f), 0.1f, 0.2f,HierarchyClass.LOW_LAYER)

        lineLeft = Line(24,Point(0.4f, 0f, 0f), 0.15f, 2f,HierarchyClass.LOW_LAYER)
        lineRight = Line(25,Point(-0.4f, 0f, 0f), 0.15f, 2f,HierarchyClass.LOW_LAYER)
        lineMid = Line(26,Point(0f, 0f, 0f), 0.15f, 2f,HierarchyClass.LOW_LAYER)
...
//        addTextureModel(Table(1001, context, R.drawable.table, Point(0f, 0f, 0f)))
    ...
    override fun drawTextureModel() {
        textureModelMap.forEach { key, value ->
            if (value.hierarchy == HierarchyClass.LOW_LAYER) {
                drawTextureModel(value)
            }
        }
        textureModelMap.forEach { key, value ->
            if (value.hierarchy == HierarchyClass.MID_LAYER) {
                drawTextureModel(value)
            }
        }
        textureModelMap.forEach { key, value ->
            if (value.hierarchy == HierarchyClass.HIGHT_LAYER) {
                drawTextureModel(value)
            }
        }
    }
